...
class rnd_digi_business
{
    public function __construct()
    {
        ...
        add_action('init', array($this, 'rnd_digi'));
        add_action('init', array($this, 'rnd_digi_taxonomy'));
    ...
    public function rnd_enque_js_css_frontend()
    {
        ...
        wp_enqueue_script('rnd_prefix_bootstrap');
        ...
        wp_register_style('rnd_styles_bootstrap', plugins_url('/css/bootstrap.css', __FILE__),array(),true);
        wp_enqueue_style('rnd_styles');
        wp_enqueue_style('rnd_styles_all');
        wp_enqueue_style('rnd_styles_bootstrap');
    }
    ...
    public function rnd_digi_gallery_save($post_id)
    {
        ...
        // Correct post type
        if ('digi' != $_POST['post_type']) { // here you can set the post type name
            return;
        }
